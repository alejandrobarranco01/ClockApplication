...
ENTITY bcd_7segment IS
    PORT(bcd_in : IN STD_LOGIC_VECTOR (3 downto 0); seven_segment_out : OUT STD_LOGIC_VECTOR (6 downto 0));
END bcd_7segment;
...
begin
    ...
    begin
	 -- Check if input is invalid BCD (greater than 9)
        if (A = '1' AND B = '1' AND C = '1' AND D = '1') then
         -- Turn off all segments for invalid inputs
         seven_segment_out <= "1111111"; -- All segments off
			else
